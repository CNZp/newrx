...
RX.config = {
    ...
    alias: {
        ...
        'layer': '/medias/plugin/layer3.1.1/layer.js',
    ...
    cssAlias: {
        ...
        'menu': '/medias/style/plat/menu.css',
        'menu_bar': '/medias/style/plat/menu_bar.css',
        ...
        'zTree': '/medias/plugin/zTreeStyle/zTreeStyle.css',
        ...
        'roleRelate': '/medias/style/plat/roleRelate.css',
        'flow':'/medias/style/plat/flow.css'
    },
