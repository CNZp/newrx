        ...
        if (total != null && total != 0) {
            ...
            function buildPages(current) {
                ...
                var sPageing = "<div class='rx-paging'>" +
                    "<ul class='rx-pagenate'><li class='rx-frist paged' disabled>&lt;&lt;</li>" +
                ...
                sPageing += sLi + "</ul></div></li>" +
                    "<li class='rx-last paged'>&gt;&gt;</li></ul>" +
                    "<span style='display:block;width:auto;float:right;padding:0 10px;height:24px;font-size: 12px;text-indent: 15px;line-height:24px;color: #999'>" +
