            ...
            if(this.collection.models.length > 0) {
                $.each(this.collection.models, function (key, model) {
                    if (model.get("sfyx_st") != "UNVALID") {
                        elementStr += "<td>";
                        if (type == "inOrgan") {
                            elementStr += "<img class='elementSrc' align='absmiddle' src='"+RX.handlePath("/medias/style/plat/image/role/inOrgan.png")+"'>";
                        } else if (type == "outOrgan") {
                            elementStr += "<img class='elementSrc' align='absmiddle' src='"+RX.handlePath("/medias/style/plat/image/role/outOrgan.png")+"'>";
                        } else if (type == "inPost") {
                            elementStr += "<img class='elementSrc' align='absmiddle' src='"+RX.handlePath("/medias/style/plat/image/role/inPost.png")+"'>";
                        } else if (type == "outPost") {
                            elementStr += "<img class='elementSrc' align='absmiddle' src='"+RX.handlePath("/medias/style/plat/image/role/outPost.png")+"'>";
                        } else if (type == "inUser") {
                            elementStr += "<img class='elementSrc' align='absmiddle' src='"+RX.handlePath("/medias/style/plat/image/role/inUser.png")+"'>";
                        } else if (type == "outUser") {
                            elementStr += "<img class='elementSrc' align='absmiddle' src='"+RX.handlePath("/medias/style/plat/image/role/outUser.png")+"'>";
                        }
