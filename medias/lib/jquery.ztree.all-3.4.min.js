...
(function (k) {
    var F, G, H, I, J, K, s = {}, L = {}, t = {}, M = {
        ...
        w = [function (b) {
            ...
            var a = b.target, c = g.getSetting(b.data.treeId), d = "", f = null, h = "", l = "", i = null, n = null,
                r = null;
            if (j.eqs(b.type, "mousedown")) l = "mousedown"; else if (j.eqs(b.type, "mouseup")) l = "mouseup"; else if (j.eqs(b.type, "contextmenu")) l = "contextmenu"; else if (j.eqs(b.type, "click")) if (j.eqs(a.tagName, "span") && a.getAttribute("treeNode" +
                ...
                if (r = j.getMDom(c, a, [{
                    ...
                    }])) d = (k(r).parent("li").get(0) || k(r).parentsUntil("li").parent().get(0)).id, h = "clickNode"
            } else if (j.eqs(b.type, "dblclick") && (l = "dblclick", r = j.getMDom(c, a, [{
                    tagName: "a",
                    attrName: "treeNode" + e.id.A
                }]))) d = (k(r).parent("li").get(0) || k(r).parentsUntil("li").parent().get(0)).id, h = "switchNode";
            if (l.length > 0 && d.length == 0 && (r = j.getMDom(c,
                    a, [{
                        tagName: "a",
                        attrName: "treeNode" + e.id.A
                    }]))) d = (k(r).parent("li").get(0) || k(r).parentsUntil("li").parent().get(0)).id;
            if (d.length > 0) switch (f = g.getNodeCache(c, d), h) {
                case "switchNode":
                    f.isParent ? j.eqs(b.type, "click") || j.eqs(b.type, "dblclick") && j.apply(c.view.dblClickExpand, [c.treeId, f], c.view.dblClickExpand) ? i = F : h = "" : h = "";
                    break;
                case "clickNode":
                    i = G
            }
            ...
            return {
                stop: !1, node: f, nodeEventType: h, nodeEventCallback: i,
            ...
            addCreatedNode: function (b, a) {
                ...
                for (var d = 0, f = A.length; d < f; d++) A[d].apply(this,
                    arguments)
                ...
                if (!a || !c) return null;
                for (var f =
                    b.data.key.children, h = 0, l = a.length; h < l; h++) {
                ...
                if (!a) return null;
                var c = t[b.treeId].nodes[g.getNodeCacheId(a)];
                return c ? c : null
                ...
                if (a[c]) for (var d = 0, f = a[c].length; d < f; d++) arguments.callee(b,
                    a[c][d]);
                ...
                for (var c = 0, d = E.length; c < d; c++) E[c].apply(this, arguments)
                ...
                if (j.isArray(a)) {
                    ...
                    for (c = 0, d = a.length; c < d; c++) g[a[c][h]] && a[c][f] != a[c][h] ? (g[a[c][h]][l] || (g[a[c][h]][l] =
                        []), g[a[c][h]][l].push(a[c])) : e.push(a[c]);
                    return e
                } else return [a]
            }
        }, m = {
            bindEvent: function (b) {
                ...
                for (var a = [], c = 0, d = y.length; c < d; c++) {
                    var f = y[c].apply(this, arguments);
                    a.push(f);
                    if (f.stop) break
                }
                return a
                ...
                for (var c = m.doProxy(b), d = !0, f = !1, h = 0, e = c.length; h < e; h++) {
                    var i = c[h];
                    i.nodeEventCallback && (f = !0, d = i.nodeEventCallback.apply(i,
                        [b, i.node]) && d);
    ...
    G = function (b, a) {
        var c = g.getSetting(b.data.treeId), d = c.view.autoCancelSelected && b.ctrlKey &&
        g.isSelectedNode(c, a) ? 0 : c.view.autoCancelSelected && b.ctrlKey && c.view.selectedMulti ? 2 : 1;
    ...
    I = function (b, a) {
        var c = g.getSetting(b.data.treeId);
        j.apply(c.callback.beforeMouseUp,
            [c.treeId, a], !0) && j.apply(c.callback.onMouseUp, [b, c.treeId, a]);
        return !0
    };
    J = function (b, a) {
        var c = g.getSetting(b.data.treeId);
    ...
    var j = {
        apply: function (b, a, c) {
            return typeof b == "function" ? b.apply(N,
                a ? a : []) : c
            ...
            if (b instanceof Array) {
                a = [];
                for (var c = b.length; c--;) a[c] = arguments.callee(b[c]);
                return a
            } else if (typeof b == "function") return b; else if (b instanceof Object) {
                a = {};
        ...
        addNodes: function (b, a, c, d) {
            ...
            for (var e = [], j = b.data.key.children,
                ...
                var o = c[k];
                if (f) {
                    var q = (d ? d : g.getRoot(b))[j].length == c.length && k == 0;
                    g.initNode(b, a, o, d, q, k == c.length - 1, h);
                    g.addNodeCache(b, o)
                }
                q = [];
                o[j] && o[j].length > 0 && (q = i.appendNodes(b, a + 1, o[j], o, f, h && o.open));
                h && (i.makeDOMNodeMainBefore(e, b, o), i.makeDOMNodeLine(e, b, o), g.getBeforeA(b, o, e), i.makeDOMNodeNameBefore(e, b, o), g.getInnerBeforeA(b, o, e), i.makeDOMNodeIcon(e, b, o), g.getInnerAfterA(b, o, e), i.makeDOMNodeNameAfter(e, b, o), g.getAfterA(b, o, e), o.isParent && o.open && i.makeUlHtml(b, o, e, q.join("")),
                    i.makeDOMNodeMainAfter(e, b, o), g.addCreatedNode(b, o))
            }
            return e
        }, appendParentULDom: function (b, a) {
            var c = [], d = k("#" + a.tId), f = k("#" + a.tId + e.id.UL),
            ...
            var g = b.async.contentType == "application/json", p = g ? "{" : "", n = "";
            for (f = 0, h = b.async.autoParam.length; a && f < h; f++) {
                var m = b.async.autoParam[f].split("="), o = m;
                m.length > 1 && (o = m[1], m = m[0]);
                g ? (n = typeof a[m] == "string" ? '"' : "", p += '"' + o + ('":' + n + a[m]).replace(/'/g, "\\'") + n + ",") : p += o + ("=" + a[m]).replace(/&/g, "%26") + "&"
            }
            if (j.isArray(b.async.otherParam)) for (f = 0, h = b.async.otherParam.length; f <
            h; f += 2) g ? (n = typeof b.async.otherParam[f + 1] == "string" ? '"' : "", p += '"' + b.async.otherParam[f] + ('":' + n + b.async.otherParam[f + 1]).replace(/'/g, "\\'") + n + ",") : p += b.async.otherParam[f] + ("=" + b.async.otherParam[f + 1]).replace(/&/g, "%26") + "&"; else for (var q in b.async.otherParam) g ? (n = typeof b.async.otherParam[q] == "string" ? '"' : "", p += '"' + q + ('":' + n + b.async.otherParam[q]).replace(/'/g, "\\'") + n + ",") : p += q + ("=" + b.async.otherParam[q]).replace(/&/g, "%26") + "&";
            ...
            for (var c = g.getRoot(b).curSelectedList, d = c.length - 1; d >= 0; d--) if (!a || a === c[d]) if (k("#" + c[d].tId + e.id.A).removeClass(e.node.CURSELECTED), i.setNodeName(b, c[d]), a) {
            ...
            b && (g.initCache(b), g.initRoot(b), m.unbindTree(b), m.unbindEvent(b), b.treeObj.empty())
        }, expandCollapseNode: function (b,
                                         a, c, d, f) {
            ...
            var h = g.getRoot(b), e = b.data.key.children, h = a ? a[e] : h[e], e = a ? !1 : d,
            ...
            b.push("<span id='", c.tId, e.id.SWITCH, "' title='' class='", i.makeNodeLineClass(a, c), "' treeNode",
                e.id.SWITCH, "></span>")
            ...
            b.push("<a id='", c.tId, e.id.A, "' class='level", c.level, "' treeNode", e.id.A, ' onclick="', c.click ||
                "", '" ', f != null && f.length > 0 ? "href='" + f + "'" : "", " target='", i.makeNodeTarget(c), "' style='", l.join(""), "'");
            ...
            var c = ["ico"];
            a.isAjaxing || (c[0] = (a.iconSkin ? a.iconSkin + "_" : "") + c[0], a.isParent ?
            ...
            var c = [];
            b.view.showLine ? a.level == 0 && a.isFirstNode && a.isLastNode ? c.push(e.line.ROOT) :
                a.level == 0 && a.isFirstNode ? c.push(e.line.ROOTS) : a.isLastNode ? c.push(e.line.BOTTOM) : c.push(e.line.CENTER) : c.push(e.line.NOLINE);
            ...
            c.push("<ul id='", a.tId, e.id.UL,
                "' class='level", a.level, " ", i.makeUlLineClass(b, a), "' style='display:", a.open ? "block" : "none", "'>");
            c.push(d);
            c.push("</ul>")
            ...
            if (a) {
                ...
                if (d) {
                    ...
                    delete a[c];
                    b.data.keep.parent ? k("#" + a.tId + e.id.UL).empty() : (a.isParent = !1, a.open = !1, c = k("#" + a.tId + e.id.SWITCH), d = k("#" + a.tId + e.id.ICON),
                        i.replaceSwitchClass(a, c, e.folder.DOCU), i.replaceIcoClass(a, d, e.folder.DOCU), k("#" + a.tId + e.id.UL).remove())
                }
            }
            ...
            if (g.getNodeCache(b, a.tId)) {
                ...
                i.setLastNode(b, f);
                var j, h = f[d].length;
                if (!b.data.keep.parent && h == 0) f.isParent = !1, f.open = !1, h = k("#" + f.tId + e.id.UL), l = k("#" + f.tId + e.id.SWITCH), j = k("#" + f.tId + e.id.ICON), i.replaceSwitchClass(f, l, e.folder.DOCU), i.replaceIcoClass(f, j, e.folder.DOCU), h.css("display", "none"); else if (b.view.showLine && h > 0) {
                    var n =
                        f[d][h - 1], h = k("#" + n.tId + e.id.UL), l = k("#" + n.tId + e.id.SWITCH);
                    j = k("#" + n.tId + e.id.ICON);
            ...
            k("#" + a.tId +
                e.id.A).addClass(e.node.CURSELECTED);
            ...
            if (a) {
                var c = k("#" + a.tId + e.id.SWITCH), d = k("#" + a.tId + e.id.UL), f = k("#" + a.tId + e.id.ICON),
                ...
                f.removeAttr("style");
                f.attr("style", i.makeNodeIcoStyle(b,
                    a));
    ...
    k.fn.zTree = {
        consts: {
            ...
            }, id: {A: "_a", ICON: "_ico", SPAN: "_span", SWITCH: "_switch", UL: "_ul"}, line: {
                ROOT: "root", ROOTS: "roots", CENTER: "center",
                BOTTOM: "bottom", NOLINE: "noline", LINE: "line"
            }, folder: {OPEN: "open", CLOSE: "close", DOCU: "docu"}, node: {CURSELECTED: "curSelectedNode"}
        }, _z: {tools: j, view: i, event: m, data: g}, getZTreeObj: function (b) {
            ...
            c = {
                setting: d, addNodes: function (a, b, c) {
                    ...
                    i.cancelPreSelectedNode(this.setting,
                        a)
                }, destroy: function () {
                    ...
                    g.getRoot(d).expandTriggerFlag =
                        m;
                    c ? i.expandCollapseSonNode(this.setting, a, b, !0, function () {
                        e !== !1 && k("#" + a.tId).focus().blur()
                    }) : (a.open = !b, i.switchNode(this.setting, a), e !== !1 && k("#" + a.tId).focus().blur());
                    return b
                }, getNodes: function () {
                    ...
                    return !a ? null : g.getNodesByParam(this.setting,
                        c ? c[this.setting.data.key.children] : g.getNodes(this.setting), a, b)
                    ...
                    b = !!b;
                    return !a || typeof a != "function" ? b ? null : [] : g.getNodesByFilter(this.setting, c ? c[this.setting.data.key.children] : g.getNodes(this.setting), a, b, d)
                }, getNodeIndex: function (a) {
                    if (!a) return null;
                    for (var b = d.data.key.children, c = a.parentTId ? a.getParentNode() :
                        g.getRoot(this.setting), e = 0, i = c[b].length; e < i; e++) if (c[b][e] == a) return e;
                    return -1
                    ...
                    a && (b = !!b, b && j.apply(d.callback.beforeRemove, [d.treeId, a], !0) == !1 || (i.removeNode(d,
                        a), b && this.setting.treeObj.trigger(e.event.REMOVE, [d.treeId, a])))
                }, selectNode: function (a, b,fun) {
                    a && j.uCanDo(this.setting) && (b = d.view.selectedMulti && b, a.parentTId ? i.expandCollapseParentNode(this.setting, a.getParentNode(), !0, !1, function () {
                        fun ? fun(a) :  k("#" + a.tId).focus().blur()
                    }) : fun ? fun(a) :  k("#" + a.tId).focus().blur(), i.selectNode(this.setting, a, b))
                    ...
                    a &&
                    k("#" + a.tId).get(0) && j.uCanDo(this.setting) && (i.setNodeName(this.setting, a), i.setNodeTarget(a), i.setNodeUrl(this.setting, a), i.setNodeLineIcos(this.setting, a), i.setNodeFontCss(this.setting, a))
                }
            };
            b.treeTools = c;
            g.setZTreeTools(d, c);
    ...
    m.extend(!0, m.fn.zTree._z, {
        tools: {}, view: {
            checkNodeRelation: function (c, a) {
                ...
                var b = c.data.key.checked, d = j.checkbox, g = j.radio, e = "",
    ...
    f.addZTreeTools(function (c, a) {
        a.checkNode = function (a, b, f, h) {
            ...
            if (a.chkDisabled !== !0 && (b !== !0 && b !== !1 && (b = !a[i]), h = !!h, (a[i] !== b || f) && !(h && k.apply(this.setting.callback.beforeCheck, [this.setting.treeId, a], !0) == !1) && k.uCanDo(this.setting) && this.setting.check.enable && a.nocheck !== !0)) a[i] = b, b = m("#" + a.tId + j.id.CHECK), (f || this.setting.check.chkStyle === j.radio.STYLE) && e.checkNodeRelation(this.setting, a), e.setChkClass(this.setting, b, a), e.repairParentChkClassWithSelf(this.setting,
                a), h && c.treeObj.trigger(j.event.CHECK, [c.treeId, a])
        };
...
(function (k) {
        ...
        onHoverOverNode: function (b, a) {
            ...
            function c(b) {
                ...
                if (z.dragFlag == 1) {
                    ...
                    c = b.clientY + B - l.top;
                    var o = i.treeObj.height() + l.top - b.clientY - B, n = b.clientX + j - l.left,
                    ...
                    var s = o < g.edit.drag.borderMax && o > g.edit.drag.borderMin,
                        ...
                        N = C && i.treeObj.scrollLeft() + i.treeObj.width() + 10 >= e;
            ...
            function q(b) {
                ...
                if (z.dragFlag != 0) {
                    z.dragFlag = 0;
                    var a, l, j;
                    for (a = 0, l = m.length; a < l; a++) j = m[a], j.isParent && z.dragNodeShowBefore[j.tId] &&
                    !j.open && (f.expandCollapseNode(g, j, !j.open), delete z.dragNodeShowBefore[j.tId]);
                    y && y.remove();
                    t && t.remove();
                    ...
                    if (r) {
                        ...
                        if (h.apply(g.callback.beforeDrop, [i.treeId, m, n, v, o], !0) != !1) {
                            ...
                            a = function () {
                                ...
                                } else if (o && v == d.move.TYPE_INNER) f.addNodes(i, n, s); else if (o && f.addNodes(i, n.getParentNode(), s), v == d.move.TYPE_PREV) for (b = 0, a = s.length; b < a; b++) f.moveNode(i, n, s[b], v, !1); else for (b = -1, a = s.length - 1; b < a; a--) f.moveNode(i, n, s[a], v, !1);
            ...
            var x = k(document), y, t, r, G = !1, i = g, D, E, P = null, Q = null, u = null, v = d.move.TYPE_INNER,
                K = b.clientX, L = b.clientY, J = (new Date).getTime();
        ...
        tools: {
            getAbs: function (b) {
                ...
                if (a) for (var d = k("iframe"), e = 0, f = d.length; e < f; e++) {
                    var j = d.get(e), g = h.getAbs(j),
                        j = k("<div id='zTreeMask_" + e + "' class='zTreeMask' style='top:" + g[1] + "px; left:" + g[0] + "px; width:" + j.offsetWidth + "px; height:" + j.offsetHeight + "px;'></div>");
                    j.appendTo("body");
            ...
            addEditBtn: function (b, a) {
                ...
                if (a != c && (!b.data.keep.leaf ||
                    ...
                    } else a.isFirstNode && q == d.move.TYPE_PREV ? (j[g].splice(y, 0, c), o = a, o.isFirstNode = !1, c.parentTId = a.parentTId, c.isFirstNode = !0, c.isLastNode =
                        !1) : a.isLastNode && q == d.move.TYPE_NEXT ? (j[g].splice(y + 1, 0, c), o = a, o.isLastNode = !1, c.parentTId = a.parentTId, c.isFirstNode = !1, c.isLastNode = !0) : (q == d.move.TYPE_PREV ? j[g].splice(y, 0, c) : j[g].splice(y + 1, 0, c), c.parentTId = a.parentTId, c.isFirstNode = !1, c.isLastNode = !1);
            ...
            removeTreeDom: function (b, a) {
                ...
                if (c !== a.level) {
                    var b = k("#" + a.tId), f = k("#" + a.tId + d.id.A), e = k("#" + a.tId + d.id.UL), c = "level" + c,
                        a = "level" + a.level;
                    b.removeClass(c);
                    b.addClass(a);
                    f.removeClass(c);
    ...
    p.exSetting({
        edit: {
            ...
            beforeDrag: null, beforeDragOpen: null, beforeDrop: null, beforeEditName: null,
    ...
    p.addInitProxy(function (b) {
        var a = b.target, c = p.getSetting(b.data.treeId), f = b.relatedTarget, e = "", l = null, j = "", g = null,
            k = null;
